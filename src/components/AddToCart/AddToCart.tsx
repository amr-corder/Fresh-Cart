  ...
  return (
    <CardFooter className="gap-2 p-0 mt-0">
      <Button
        ...
        className="flex-1 h-11 rounded-xl bg-blue-800 text-white font-semibold flex items-center justify-center gap-2
        shadow-sm cursor-pointer transition-all duration-300 hover:bg-blue-950 hover:shadow-md active:scale-[0.98]
        disabled:opacity-70 disabled:cursor-not-allowed border border-green-300 hover:ring-2 hover:ring-green-900/20">
        {isLoading ? (
